 ...
 *            attempts to remove an item from an empty deque; throw an
 *            UnsupportedOperationException if the client calls the remove()
 *            method in the iterator; throw a java.util.NoSuchElementException
